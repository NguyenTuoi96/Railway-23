...
VALUES 
	(11, 'ngocha96@gmail.com', 'NgocHa96', 'Nguyễn Ngọc Hà', 13, 2, '2019-11-18'),
    (12, 'nguyenhuong12@gmail.com', 'HuongNguyen', 'Nguyễn Thanh Hương', 2, 2, '2019-12-15'),
    (13, 'huongnhai@gmail.com', 'HuongNhai', 'Phạm Hương Nhài', 2, 3, '2020-11-15'),
    ...
    (31, 'thanhhuong01@gmail.com', 'ThanhHuong', 'Nguyễn Thanh Hương', 3, 4, '2020-08-25'),
    (32, 'dangdao@gmail.com', 'DaoDang', 'Đặng Thanh Dào', 2, 4, '2019-01-01');
-- Table 4: group
...
VALUES 
	...
	(10, 'câu hỏi question test 10', 13, 1, 12, '2021-01-11'),
	(11, 'content question test 11', 15, 2, 16, '2021-01-11'),
	(12, 'câu hỏi question test 12', 18, 2, 18, '2021-01-11'),
	(13, 'câu hoi question test 13', 19, 1, 17, '2021-01-11'),
	(14, 'content question test 14', 15, 2, 16, '2021-01-11'),
	(15, 'câu hỏi question test 15', 18, 2, 18, '2021-01-11'),
	(16, 'content question test 16', 17, 1, 17, '2021-01-11'),
	(17, 'câu hỏi question test 17', 20, 1, 14, '2021-01-11');
-- Table 9: answer
...
VALUES 
	...
	(8, 'PT', 'title python', 10, 120, 13, '2021-06-15'),
	(9, 'JQ', 'title jquery', 11, 60, 12, '2021-06-25'),
	(10, 'RC', 'title react', 12, 120, 6, '2021-09-05'),
	(11, 'HT', 'title html', 13, 45, 13, '2021-10-11'),
	(12, 'CCS', 'title css', 14, 120, 15, '2021-10-15'),
	(13, 'C+', 'title c++', 15, 60, 12, '2021-06-25'),
	(14, 'C', 'title C', 16, 120, 16, '2021-09-05'),
	(15, 'BT', 'title Bootstrap', 17, 45, 13, '2021-10-11'),
	(16, 'AG', 'Angular', 18, 120, 15, '2021-10-15'),
	(17, 'JN', 'Json', 19, 120, 15, '2019-10-15'),
	(18, 'AJ', 'Ajax', 20, 120, 15, '2021-10-15');
